...
class AcceptedApplicantsController extends Controller
{
    public function index()
    {
        ...
        $applications = ApplicationForm::with('user')->whereIn('status', ['Ready for Interview', 'Accepted by Assessor', 'Final Admission List'])->get();
        return view('admin.accepted_applicants.index', compact('applications'));
    }

    /**
     * Show list of approved applicants (Final Admission List)
     */
    public function approvedList()
    {
        $approvedApplications = ApplicationForm::with('user')->where('status', 'Final Admission List')->get();
        return view('admin.accepted_applicants.approved', compact('approvedApplications'));
    }
    ...
    public function approve(Request $request)
    {
        ...
        $application->status = 'Final Admission List';
