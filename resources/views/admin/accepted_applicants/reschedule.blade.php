...
<div class="min-h-screen p-4 sm:p-6 lg:p-8 relative font-franklin" style="background: linear-gradient(165deg, #FFFEF7 0%, #f0f7f0 50%, #FEFDFB 100%);">
    ...
    @endif
    @if(session('success'))
    <div class="relative z-10 flex items-center gap-3 px-4 sm:px-5 py-3 sm:py-4 mb-4 sm:mb-6 rounded-xl font-medium text-green-800 max-w-[1100px] mx-auto text-sm sm:text-base" 
